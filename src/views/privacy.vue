<template>
  <div id="privacy">
    <div class="privacy text-sm mt-20 text-justify mb-24 px-4 md:px-24">
      <h1 class="mt-4 text-xl">Datenschutz&shy;erkl&auml;rung</h1>
      <h2 class="mt-4 text-xl">1. Datenschutz auf einen Blick</h2>
      <h3 class="mt-4 text-xl">Allgemeine Hinweise</h3>
      <p>
      ...
      <h3 class="mt-4 text-xl">Datenerfassung auf dieser Website</h3>
      ...
      <h4 class="mt-4 text-xl">Wie erfassen wir Ihre Daten?</h4>
      <p>
      ...
      <p>
        ...
        Uhrzeit des Seitenaufrufs, IP-Adresse). Die Erfassung dieser Daten erfolgt
        automatisch, sobald Sie diese Website betreten.
      </p>
      <h4 class="mt-4 text-xl">Wof&uuml;r nutzen wir Ihre Daten?</h4>
      <p>
        Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der
        Website zu gew&auml;hrleisten. Andere Daten k&ouml;nnen zur Analyse
        Ihres Nutzerverhaltens verwendet werden.
      </p>
      <h4 class="mt-4 text-xl">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
      <p>
      ...
      <h3 class="mt-4 text-xl">Analyse-Tools und Tools von Dritt&shy;anbietern</h3>
      <p>
      ...
      <h2 class="mt-4 text-xl">2. Hosting</h2>
      <h3 class="mt-4 text-xl">Externes Hosting</h3>
      <p>
      ...
      <h2 class="mt-4 text-xl">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
      <h3 class="mt-4 text-xl">Datenschutz</h3>
      <p>
      ...
      <h3 class="mt-4 text-xl">Hinweis zur verantwortlichen Stelle</h3>
      <p>
      ...
      <p>
        ...
        Professur f&uuml;r Marketing &amp; Customer Insight<br />
        Moorweidenstra&szlig;e 18,<br />
        Raum 3. Stock (Raum 3035),<br />
        20148 Hamburg
      </p>

      <p>
        Telefon: +4940428388676<br />
        E-Mail: maximilian.witte@uni-hamburg.de
      </p>
      <p>
      ...
      <h3 class="mt-4 text-xl">Speicherdauer</h3>
      <p>
      ...
      <h3 class="mt-4 text-xl">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
      <p>
      ...
      <h3 class="mt-4 text-xl">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
      <p>
      ...
      <h3 class="mt-4 text-xl">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
      <p>
      ...
      <h3 class="mt-4 text-xl">Auskunft, L&ouml;schung und Berichtigung</h3>
      <p>
      ...
      <h3 class="mt-4 text-xl">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
      <p>
      ...
      <h2 class="mt-4 text-xl">4. Datenerfassung auf dieser Website</h2>
      <h3 class="mt-4 text-xl">Cookies</h3>
      <p>
