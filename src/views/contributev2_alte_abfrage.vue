        ...
        >
          <div id="input_text" class="relative w-full md:w-96 tooltip">
            <input
              ...
              "
            />
            <span v-if="calculated" class="tooltiptext text-base"
              >Bitte gib zuerst Feedback zu deiner Eingabe</span
            >
            <button
              :disabled="calculated"
              @click="deleteInput"
      ...
      <div id="output_text" class="positioner flex-col">
        ...
        <div id="output" class="grid-container md:mt-6 text-2xl">
          ...
          >
            ...
            <div class="moreInfo mt-4 text-base">
              <button
                ...
                :class="get_moreInformation_button_color('cdu')"
          ...
          >
            ...
            <div class="moreInfo mt-4 text-base">
              <button
                @click="send_request_more_information('spd')"
                :class="get_moreInformation_button_color('spd')"
                title="Zeige Textstellen aus dem Wahlprogramm und Tweets"
                class="
                  rounded-full
                  border-2
          ...
          >
            ...
            <div class="moreInfo mt-4 text-base">
              <button
                @click="send_request_more_information('fdp')"
                :class="get_moreInformation_button_color('fdp')"
                title="Zeige Textstellen aus dem Wahlprogramm und Tweets"
                class="
                  rounded-full
                  border-2
          ...
          >
            ...
            <div class="moreInfo mt-4 text-base">
              <button
                ...
                :class="get_moreInformation_button_color('grüne')"
                title="Zeige Textstellen aus dem Wahlprogramm und Tweets"
                class="
                  rounded-full
                  border-2
          ...
          >
            ...
            <div class="moreInfo mt-4 text-base">
              <button
                ...
                :class="get_moreInformation_button_color('linke')"
                title="Zeige Textstellen aus dem Wahlprogramm und Tweets"
                class="
                  rounded-full
                  border-2
          ...
          >
            ...
            <div class="moreInfo mt-4 text-base">
              <button
                @click="send_request_more_information('afd')"
                :class="get_moreInformation_button_color('afd')"
                title="Zeige Textstellen aus dem Wahlprogramm und Tweets"
                class="
                  rounded-full
                  border-2
        ...
        <div
          ...
          class="loader-wrapper text-xl mt-4"
        >
          <div class="loader mt-6">
            <div></div>
            <div></div>
...
export default {
  ...
  computed: {
    ...
    getNotAllowed() {
      return this.calculated ? "cursor-not-allowed" : "";
    },
    getQualtricsHREF() {
  ...
  methods: {
    ...
    send_request_more_information(id) {
      ...
      backend_functions.send_request_more_information(data);
      setTimeout(() => this.triggerCollect_request_more_information(), 4000);
    },
